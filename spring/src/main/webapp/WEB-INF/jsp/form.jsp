...
<div class="container">
    ...
    <ul class="nav nav-tabs">
        <li><a href="/resources/basic.html">Basic</a></li>
        <li><a href="/resources/basic-plus.html">Basic Plus</a></li>
        <li class="active"><a href="/resources/index.html">Basic Plus UI</a></li>
        <li><a href="/resources/angularjs.html">AngularJS</a></li>
        <li><a href="/resources/jquery-ui.html">jQuery UI</a></li>
    </ul>
    <br>
    <blockquote>
...
<script src="/resources/js/cors/jquery.xdr-transport.js"></script>
<![endif]-->
</body>
</html>
